// Deploy the equity-quote edge function over the Management API (HTTPS).
// Usage:  SUPABASE_ACCESS_TOKEN=sbp_... node scripts/deploy-equity-quote.js
