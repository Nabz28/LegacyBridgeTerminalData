...
insert into brain.bridge_config (key, value) values
  ...
  ('model_main',    '"anthropic/claude-sonnet-4.6"'::jsonb),               -- analysis / tool-use default
  ('model_fast',    '"anthropic/claude-haiku-4.5"'::jsonb),                -- nav / intent routing (note: not yet read by bridge.js)
